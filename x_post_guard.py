...
NG_PATTERNS = [
    ...
    # 代理店キューの a03/a10/a11 が全部この形（「DMして」「まずは話聞きたい人DMして」）。
    ...
    # [[feedback_dont_make_up_numbers]] 業界の市場規模・成長率は裏取りがない。
    # 代理店キューの a09「市場規模は毎年130%以上成長」が素通りしていた。
    (r"市場(?:規模)?[^。\n]{0,12}[0-9]{2,3}\s*[%％]"
     r"|毎年\s*[0-9]{2,3}\s*[%％]"
    ...
    # 「不労所得」と言い換えただけの形も同じ扱い（代理店キュー a18 で素通りしていた）
