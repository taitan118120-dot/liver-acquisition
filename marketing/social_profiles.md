...
| Threads @taitanblog | 設計版を反映済み | **反映済み**（2026-08-01、Web UIで表示名・bio・リンクを更新して実画面で確認） |
| Instagram @taitan_pro | IRIAM記載あり／LP直リンク | **未反映**（手動更新が必要） |
| Instagram @taitanblog | 旧・個人版（lit.link） | **未反映**（手動更新が必要） |
