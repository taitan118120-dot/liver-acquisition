...
# 2026-08-28: 「ステップ3：オンライン面談を提案」（#42 スカウト術）はこの集合から外した。
#   ユーザー指示で方針変更し note_facts_fix_20260828.py が
#   「ステップ3：LINE通話での面談を提案」へ直した。読者＝代理店が自分の見込み客へ
#   提案する手順ではあるが、直下のDM例文が既に「LINEのビデオ通話でOKです」で、
#   見出しだけ表記が割れていた。素の「面談」（ステップ4以降）は今までどおり残す。
