...
# =====================================================================
APPROVED_FACTS = """- TAITAN PROは還元率100%（事務所の取り分なし）
...
VIRAL_THEMES = [
    ...
    {"id": "jimusho_kangen", "type": "story", "tag": "事務所のリアル", "use_facts": True,
     ...
     "angle": "事務所によって還元率が違う事実を知らずに契約する人が多い。TAITAN PROは還元率100%という事実を1枚だけさらっと入れる（宣伝臭は最小限に）"},
    ...
    {"id": "ayashii_scout", "type": "ng", "tag": "事務所のリアル",
     ...
     "angle": "DMスカウトの全部が悪ではないが、危険なパターンは明確にある。還元率を濁す、契約を急かす、辞められない契約。業界側からの注意喚起は信頼を生む"},
...
{facts_block}
【ターゲット読者】
ライブ配信をやっている・これから始めたい20〜30代。スマホで高速スクロール中に出会う。
