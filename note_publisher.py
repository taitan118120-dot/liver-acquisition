...
HASHTAG_MAP = {
    ...
    "37_ライバー月収平均2026":             ["ライバー月収", "ライバー収入", "月収平均", "Pococha", "17LIVE", "IRIAM", "副業", "稼ぎ方", "ライブ配信", "2026"],
    "38_ライバー代理店副業始め方ステップ": ["ライバー代理店", "代理店", "副業", "始め方", "ライバー事務所", "パートナー", "在宅副業", "0円起業", "ストック収入", "スカウト"],
    "39_ライバー代理店稼げる収入リアル":   ["ライバー代理店", "稼げる", "代理店収入", "副業収入", "ストック型", "ライバー事務所", "パートナー", "副業", "在宅", "継続報酬"],
    "40_ライバー事務所の仕組み報酬体系完全図解": ["ライバー事務所", "仕組み", "報酬体系", "マージン", "還元率", "契約", "ライバー", "フルバック", "事務所比較", "搾取"],
    "41_40代50代ライバー始め方":           ["40代ライバー", "50代ライバー", "大人の副業", "ライバー", "年齢不問", "ライブ配信", "セカンドキャリア", "Pococha", "始め方", "遅くない"],
    "42_ライバー代理店スカウト術DM返信率": ["スカウト", "DM", "ライバー代理店", "返信率", "代理店", "テクニック", "SNS", "営業", "パートナー", "ライバー事務所"],
    "43_ライバー事務所開業方法代理店との違い": ["ライバー事務所", "開業", "起業", "代理店", "独立", "事務所設立", "ライバー", "ビジネス", "法人化", "ロードマップ"],
    "44_初配信コツ":                          ["初配信", "ライバー", "緊張", "ライブ配信", "コツ", "始め方", "副業", "Pococha", "毎日note", "心理学"],
    "45_ライバー時給":                        ["ライバー", "時給", "Pococha", "副業", "稼ぎ方", "ライブ配信", "お金の勉強", "在宅ワーク", "毎日note", "ライバー事務所"],
    "46_ライバー向いてる人":                   ["ライバー", "向いてる人", "適性", "ライブ配信", "始め方", "副業", "性格", "毎日note", "自己分析", "キャリア"],
    "47_副業月5万在宅":                       ["副業", "月5万", "在宅副業", "在宅ワーク", "スマホ副業", "ライバー", "副業初心者", "お金の勉強", "毎日note", "働き方"],
    "48_Pocochaライバー始め方完全ガイド":      ["Pococha", "ライバー", "始め方", "ライブ配信", "副業", "スマホ副業", "在宅ワーク", "稼ぎ方", "ライバー事務所", "毎日note"],
    "49_Pocochaダイヤ換金完全ガイド":           ["Pococha", "ダイヤ換金", "ライバー", "確定申告", "副業", "ライブ配信", "お金の勉強", "在宅ワーク", "ライバー事務所", "毎日note"],
    "50_TikTokLIVE収益化完全ガイド":            ["TikTokLIVE", "TikTok", "ライブ配信", "ライバー", "副業", "投げ銭", "稼ぎ方", "スマホ副業", "始め方", "毎日note"],
    "51_ライバー経費完全リスト75項目":           ["確定申告", "経費", "節税", "個人事業主", "フリーランス", "副業", "ライバー", "お金の勉強", "青色申告", "ビジネス"],
    "52_Pocochaメーター期間完全攻略":           ["Pococha", "メーター期間", "ライバー", "新人ライバー", "ランクアップ", "ライバー事務所", "配信戦略", "始め方", "稼ぎ方", "ライブ配信"],
    "53_IRIAMVライバー始め方完全ガイド":         ["IRIAM", "Vライバー", "Vtuber", "顔出しなし", "ライブ配信", "ライバー", "副業", "アバター配信", "始め方", "毎日note"],
    "54_ライブ配信緊張克服メンタル術":            ["ライブ配信", "緊張", "メンタルケア", "心理学", "ライバー", "初配信", "副業", "自己肯定感", "始め方", "毎日note"],
    "60_スカウトDM返信率":                        ["スカウト", "DM", "ライバー事務所", "返信率", "営業", "代理店", "ノウハウ", "ライバー", "運用", "事務所運営"],
    "61_PocochaTikTokLIVE比較":                   ["Pococha", "TikTokLIVE", "ライバー", "ライブ配信", "比較", "副業", "稼ぎ方", "始め方", "プラットフォーム", "毎日note"],
    "62_TikTokLIVE始め方完全ガイド":              ["TikTokLIVE", "TikTok", "始め方", "ライブ配信", "ライバー", "副業", "スマホ副業", "稼ぎ方", "ロードマップ", "毎日note"],
    "63_TikTokフォロワー1000人最速":              ["TikTok", "フォロワー", "TikTokLIVE", "ライブ配信", "SNS", "増やし方", "ライバー", "始め方", "副業", "毎日note"],
    "64_TikTokLIVE稼げない原因":                  ["TikTokLIVE", "TikTok", "稼げない", "ライブ配信", "ライバー", "副業", "改善", "原因", "ノウハウ", "毎日note"],
    "65_TikTokライバー事務所選び方":              ["TikTok", "ライバー事務所", "事務所選び", "事務所比較", "ライバー", "TikTokLIVE", "還元率", "違約金", "副業", "毎日note"],
    "66_TikTokギフト換金完全ガイド":              ["TikTokLIVE", "ギフト", "換金", "ダイヤモンド", "ライバー", "副業", "確定申告", "お金の勉強", "TikTok", "毎日note"],
    "69_ライバー始める前に知るべき10のこと":       ["ライバー", "始め方", "ライブ配信", "副業", "心構え", "初心者", "準備", "在宅ワーク", "スマホ副業", "毎日note"],
    "70_リスナー0人対処法":                       ["ライバー", "ライブ配信", "リスナー", "悩み", "メンタル", "改善", "ノウハウ", "副業", "始め方", "毎日note"],
    "71_コアファン作り方完全ガイド":              ["ライバー", "コアファン", "ライブ配信", "ファン作り", "リスナー", "稼ぎ方", "ノウハウ", "副業", "戦略", "毎日note"],
    "72_ライバー雑談ネタ100選":                   ["ライバー", "雑談", "ネタ", "配信ネタ", "ライブ配信", "トーク術", "コミュニケーション", "副業", "初心者", "毎日note"],
    "73_顔バレ身バレ対策完全ガイド":              ["ライバー", "顔バレ", "身バレ", "セキュリティ", "プライバシー", "ライブ配信", "副業", "対策", "始め方", "毎日note"],
    "74_配信ゴールデンタイム完全ガイド":          ["ライバー", "配信時間", "ゴールデンタイム", "ライブ配信", "戦略", "稼ぎ方", "ノウハウ", "副業", "Pococha", "毎日note"],
    "75_ライバー親バレ対策完全ガイド":            ["ライバー", "親バレ", "副業バレ", "プライバシー", "ライブ配信", "副業", "対策", "学生", "始め方", "毎日note"],
    "76_月収100万円ライバー共通点":               ["ライバー", "月収100万円", "トップライバー", "ライブ配信", "稼ぎ方", "成功", "習慣", "副業", "ノウハウ", "毎日note"],
    "77_PocochaC帯御新規攻略":                    ["Pococha", "ポコチャ", "C帯", "御新規", "初見", "コアファン", "ライバー", "ライブ配信", "ノウハウ", "毎日note"],
    "78_ライバー事務所メリットデメリット":         ["ライバー事務所", "メリット", "デメリット", "ライバー", "副業", "Pococha", "TikTokLIVE", "還元率", "事務所選び", "毎日note"],
    "79_PocochaB帯攻略":                          ["Pococha", "ポコチャ", "B帯", "ランクアップ", "ライバー", "ライブ配信", "攻略", "同接", "コアファン", "毎日note"],
    "80_TikTokLIVEギフト増やし方":                ["TikTokLIVE", "TikTok", "ギフト", "増やし方", "ライバー", "ライブ配信", "副業", "稼ぎ方", "ノウハウ", "毎日note"],
    "81_Pococha同接増やし方":                     ["Pococha", "ポコチャ", "同接", "視聴者", "増やし方", "ライバー", "ライブ配信", "副業", "攻略", "毎日note"],
    "82_TikTokLIVE伸びない原因":                  ["TikTokLIVE", "TikTok", "伸びない", "原因", "ライバー", "ライブ配信", "副業", "フォロワー", "改善", "毎日note"],
    "87_ライバー小規模企業共済":                   ["小規模企業共済", "ライバー", "個人事業主", "節税", "確定申告", "フリーランス", "お金の勉強", "Pococha", "副業", "毎日note"],
    "88_小規模企業共済加入条件始め方":             ["小規模企業共済", "加入条件", "個人事業主", "開業届", "ライバー", "節税", "フリーランス", "お金の勉強", "副業", "毎日note"],
    "89_ライバー老後資金小規模企業共済iDeCo比較":  ["小規模企業共済", "iDeCo", "老後資金", "個人事業主", "ライバー", "節税", "フリーランス", "お金の勉強", "資産形成", "毎日note"],
    "93_2ヶ月でB2大学生ライバーむうくん":          ["Pococha", "ポコチャ", "ライバー", "B帯", "ランクアップ", "大学生副業", "ライバー事務所", "新人戦", "ライブ配信", "毎日note"],
}
