...
TARGET_DATA = {
    "beginner": {
        "job_title": "【未経験OK】ライブ配信者（ライバー）募集｜在宅・スマホ1台で月20万円目指せる",
        "salary": (
            "完全歩合制（配信プラットフォームからの報酬）\n"
            "・1ヶ月目: 配信に慣れる時期（初日から収益発生）\n"
            "・3ヶ月目目安: 月15〜20万円\n"
            "・6ヶ月目目安: 月30〜40万円\n"
            "※ 1日2時間配信の場合。進み方には個人差があります。報酬保証あり。"
        ),
        "description": (
        ...
        "what_we_do": (
            ...
            "Pococha・TikTok LIVE に対応し、11の配信代理店と提携。\n"
        ...
        "meeting_info": (
            "LINE通話で15分ほど、ライバーの仕事内容や収入の仕組みを詳しくお話しします。\n"
    ...
    "liver": {
        ...
        # Wantedly用
        "what_we_do": (
            "TAITAN PROは、200名のライバーが所属するマネジメント事務所です。\n\n"
        ...
        "meeting_info": (
            "LINE通話で15分ほど、今の状況をヒアリングします。\n"
            "「今より良くなるか知りたい」だけでもOK。\n"
            "秘密厳守。現事務所にバレることはありません。"
        ),
    },
    "sidejob": {
        "job_title": "【在宅副業】帰宅後2時間で月20万円｜ライブ配信のお仕事｜スキル不要",
        "salary": (
            "完全歩合制（配信プラットフォームからの報酬）\n"
            "・1ヶ月目: 配信に慣れる時期（初日から収益発生）\n"
            "・3ヶ月目目安: 月15〜20万円\n"
        ...
        "job_description": (
            "帰宅後の2時間をスマホで配信する。それだけで月20万円の副収入を目指せます。\n\n"
            "ライバーは他の副業と比べて、\n"
            "・初期費用0円（せどりの在庫リスクなし）\n"
            "・特別なスキル不要（プログラミング不要）\n"
            "・完全在宅（通勤なし）\n"
        ...
        "meeting_info": (
            "LINE通話で15分ほど、副業ライバーの始め方と収入の仕組みをお話しします。\n"
    ...
    "partner": {
        ...
        "how_we_do": (
            ...
            "・ライバーの還元率100%+α維持：紹介先として自信を持って勧められる"
        ),
        "job_description": (
        ...
        "meeting_info": (
            "LINE通話で15分ほど、代理店制度の詳細と報酬の仕組みをお話しします。\n"
            "「まだ迷っている」「話だけ聞きたい」でもOK。\n"
            "ノルマなし。配信頻度・時間はあなたのペースで大丈夫です。"
        ),
    },
}
