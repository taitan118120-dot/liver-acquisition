...
AGENCY_CTA_LINE = "配信代理店パートナーの仕事の中身は、ここにまとめてあります。"
...
情報を詰め込まない。事務所の話は最後の1行に、宣伝でなく事実として一言だけ添えるか、まったく触れない。""",
    "agency": """【型：代理店】100〜200字。4〜6行。
配信代理店パートナーの仕事の実際を語る。報酬額・稼げる話は主役にしない。
「還元率100%+α」はライバーへの還元条件なので、代理店パートナーの報酬の話として書くのは禁止。
